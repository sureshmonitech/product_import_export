...
require_once ("$this->plugin_path/templates/admin.php");
 ...
 public function alecadddCourse()
 {
     $value = esc_attr( get_option( 'course' ) );
     echo '<input type="text" class="regular-text" name="course" value="' . $value . '" placeholder="Write your course">';
 }
}